...
In realtà la **è la matrice di covarianza "ricavata" dal variogramma che viene utilizzata per il calcolo dei pesi** (e in un modo leggermente differente a seconda del tipo di kriging). 

Non si entra nel dettaglio di come è possibile ricavare la matrice di covarianza dal variogramma. Basti qui ricordare che esiste una relazione tra semivariogramma e covarianza:
