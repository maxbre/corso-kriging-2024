...
load(file="./old_scripts/modulo2_es05_interpolation_deterministic.rda")
# raster temperatura
temperature <- terra::rast("./data_raw/VenetoCorrectedMODIS_LST_Avg2017.tif")

# create a grid for predicting value at locations
veneto <- sf::read_sf("./data_raw/veneto.gpkg")
